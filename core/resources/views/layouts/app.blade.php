...
<head>
    ...
    <script src="{{ asset('plugin/datatables/js/jszip.min.js') }}"></script>
    <!-- <script src="{{ asset('plugin/datatables/js/pdfmake.min.js.map') }}"></script> -->
    <script src="{{ asset('plugin/datatables/js/pdfmake.min.js') }}"></script>
    <script src="{{ asset('plugin/datatables/js/pdfmake.js') }}"></script>
    ...
    <script src="{{ asset('plugin/datatables/js/buttons.print.js') }}"></script>
    ...
    <ul class="nav">
			...
			@endif
			 ...
			 <li>
				...
				<div class="{{ Request::is( 'incomecategory') || Request::is( 'expensecategory') ? 'collapse in' : 'collapse' }}" id="category" aria-expanded="{{ Request::is( 'incomecategory') || Request::is( 'expensecategory') ? 'true' : 'false' }}"
                 style="{{ Request::is( 'incomecategory') || Request::is( 'expensecategory') ? '' : 'height: 0px;' }}">
                    <ul class="nav">
...
<footer class="footer">
    <div class="container-fluid">
        ...
        <div class="copyright pull-right">
            © 2021 Developed by <span> WeGoHostU Web & App Services</span></a>
        </div>
    </div>
</footer>
</div>
