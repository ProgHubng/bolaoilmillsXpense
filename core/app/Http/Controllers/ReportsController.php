...
class ReportsController extends Controller
{
	...
	public function gettransactions(Request $request){
		...
		->select(['category.name as category', 'category.categoryid as categoryid1', 'subcategory.subcategoryid as subcategoryid2', 'subcategory.name as subcategory', 'transaction.*','account.name as account'])
